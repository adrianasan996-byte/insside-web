...
export const SPECIALISTS: SpecialistProfile[] = [
  ...
  },
  {
    ...
    slug: "daniela-pena",
    name: "Daniela Peña",
    title: "Coach en Transformación Emocional",
    category: "Life Coaching",
    shortBio:
      "Coach en transformación emocional y trabajo de sombra. Acompaña procesos de duelo, autosabotaje y reconexión con el amor propio.",
    bio: "Mi camino hacia el coaching emocional no nació de tener todas las respuestas, sino de haber sentido, muy de cerca, lo que es estar completamente desconectada de mí misma. Durante años sentía que 'hacía todo bien', pero por dentro había heridas no atendidas y un duelo profundo — no solo por la pérdida de mi padre, sino por una versión de mí misma y una vida que ya no existía. La experiencia de migrar removió muchas capas más: pérdida de identidad, desarraigo y el miedo de empezar desde cero. Fue ahí donde decidí dejar de huir de mí y empezar a regresar a casa: a mi cuerpo, a mi historia, a mi verdad. Hoy acompaño a otras personas a hacer lo mismo, desde la vivencia y no desde la teoría.",
    approach:
      "Trabajo desde un enfoque integrador, emocional y energético, en donde cada sesión es un espacio seguro para volver a ti. A través del diálogo, la escucha profunda y herramientas como el trabajo de sombra, el tapping y la escritura terapéutica, vamos explorando juntas el origen de lo que te duele, te bloquea o te aleja de tu poder. No hay fórmulas rígidas, solo presencia, intuición y compasión. Te acompaño a tu ritmo, sin juicios y con la certeza de que todo lo que necesitas ya está dentro de ti.",
    specialties: [
    ...
    credentials: [
      "Más de 3 años acompañando procesos de transformación emocional y expansión personal",
      "Coach Especialista en Transformación y Coach de Vida / Life Coach – International Coaching Group (ICG)",
      "Formación en Mindfulness y Meditación – Instituto Panchakarma",
      "Formación en Trabajo de Sombra – Seres Magnéticos / Exploradores de Sombra",
      "Formación en Meditación – Kailo Yoga",
      "Programa The Givers (Juan Lucas Martín) – NET-EFT / Tapping",
    ],
    modalities: ["online"],
    languages: ["Español"],
    rating: 5.0,
    reviewCount: 0,
    sessionPrice: 68,
    image: "/especialistas/daniela-pena.jpg",
    available: true,
    city: "Madrid",
    country: "España",
    testimonialImages: [],
    calendars: {
      individual: "https://link.insside.co/widget/booking/jib7fzWkfRzBVPimr1xl",
      package4: "https://link.insside.co/widget/booking/EYthlUSJAxv4nsIye1yq",
    },
  },
]
