...
/* ── Page ─────────────────────────────────────────────────── */
export default function ProfesionalesMainClient() {
          ...
          <div className="max-w-5xl mx-auto px-6 sm:px-12 py-4">
            <div className="flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <label htmlFor="specialist-search" className="sr-only">Buscar especialista</label>
                <input
              ...
              <label htmlFor="modality-filter" className="sr-only">Filtrar por modalidad</label>
              <select
                id="modality-filter"
                value={modality}
              ...
              <label htmlFor="sort-filter" className="sr-only">Ordenar resultados</label>
              <select
                id="sort-filter"
                value={sort}
