        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[176px_1fr_176px] items-end min-h-[300px]">
            ...
            <div className="flex flex-col items-center text-center px-8 py-14">
              <motion.h2
                className="text-3xl sm:text-4xl font-bold tracking-tight leading-[1.15] mb-7 text-white"
                initial={{ opacity: 0, y: 20 }}
                animate={inView ? { opacity: 1, y: 0 } : {}}
                transition={{ duration: 0.55, delay: 0.1 }}
              >
                Cuéntanos qué estás viviendo.<br />
                <span className="bg-gradient-to-r from-[#FDDBA0] to-[#E3812F] bg-clip-text text-transparent">Nosotros te guiamos.</span>
              </motion.h2>
