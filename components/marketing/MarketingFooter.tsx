  ...
  return (
    <footer style={{ background: "#3D4A35" }} className="py-14">
      <div className="max-w-screen-2xl mx-auto px-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 md:gap-8 mb-10">
          {/* Logo + Instagram (same row on mobile) */}
          <div className="flex items-center justify-between w-full md:w-auto">
            ...
            <a href="https://www.instagram.com/byinsside/" target="_blank" rel="noopener noreferrer"
              className="md:hidden text-white/60 hover:text-white transition-colors" aria-label="Instagram">
          ...
          <a href="https://www.instagram.com/byinsside/" target="_blank" rel="noopener noreferrer"
            className="hidden md:block text-white/60 hover:text-white transition-colors" aria-label="Instagram">
